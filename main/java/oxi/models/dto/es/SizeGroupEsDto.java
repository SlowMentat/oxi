...
public class SizeGroupEsDto implements Serializable/*, Identifiable<.*>*/
{
	@Id
	private String id;
	@JsonRawValue
	...
	public SizeGroupEsDto(){}

	public SizeGroupEsDto(String id, String metric, SizeLabelEsDto sizeLabel){
		this.id = id;
		this.metric = metric;
