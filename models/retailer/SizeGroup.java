...
public class SizeGroup extends RelatedEntity implements Serializable, Identifiable<UUID>
{
	...
	private float neck;
	@Column(name = "full_shoulder",  columnDefinition="VARCHAR(36)")
	private float fullShoulder;
	@Column(name = "half_shoulder",  columnDefinition="VARCHAR(36)")
	private float halfShoulder;
	private float chest;
	private float waist;
	private float hip;
	private float sleeve;
	@Column(name = "fron_length",  columnDefinition="VARCHAR(36)")
	private float frontLength;
	@Column(name = "back_length",  columnDefinition="VARCHAR(36)")
	private float backLength;
	@Column(name = "pant_outseam",  columnDefinition="VARCHAR(36)")
	private float pantOutseam;
	@Column(name = "pant_inseam",  columnDefinition="VARCHAR(36)")
	...
	public SizeGroup(SizeGroupDto sizeGroupDto){
		...
		this.halfShoulder = sizeGroupDto.getHalfShoulder();
