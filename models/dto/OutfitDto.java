...
public class OutfitDto implements OutfitProjection
{
	...
	public <T extends ContentProjection> void setContents(List<T> contents){logger.debug("contents[] = " + contents); this.contents = contents;}
